...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Matchfixing - The right way of fixing matches! The number one tournament generator</title>
    ...
    <body>
		...
		<div class="jumbotron homepage-intro">
			<div class="container">
				<article class="text-center">
					<h1>START FIXING YOUR OWN MATCHES</h1>
					<p>
						The fastes way of creating your own tournaments!
					</p>
					<a href="#" class="btn btn-primary">Create tournament</a>
				</article>
			</div>
		</div>
